                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <form action="{{ route('menus.update',$menu->slug) }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <textarea name="description" id="description" rows="5" cols="30" class="form-control" placeholder="Description">{{$menu->description}}</textarea>
                                        </div>
                                        ...
                                        <div class="my-3">
                                            <img src="{{asset('images/menus/'.$menu->image)}}" width="200" height="200" class="img-fluid" alt="{{$menu->title}}">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
